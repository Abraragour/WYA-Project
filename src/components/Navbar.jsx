...
import { NavLink, Link } from "react-router-dom"; // استيراد الروابط من المكتبة
  ...
  return (
    <nav style={{
      ...
      <div style={{
        ...
        {/* Logo - جعل اللوجو يرجع للرئيسية عند الضغط عليه */}
        ...
        {/* CTA Button - تحويله لـ Link لصفحة التواصل */}
        <Link
          to="/contact"
